...
const AboutUsPage = () => {
  return (
    <div className="courses-page fade-in-up delay-1" style={{ maxWidth: '1000px', margin: '0 auto', width: '100%', paddingBottom: '4rem' }}>
      <h1 className="text-gradient" style={{ fontSize: '3.5rem', textAlign: 'center', marginBottom: '3.5rem' }}>About CareerKinetic</h1>
      ...
      <div className="glass-panel fade-in-up delay-4" style={{ padding: '3.5rem', borderRadius: '24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            ...
            <p className="text-muted" style={{ margin: 0, fontSize: '1.15rem' }}>careerkinetic27@gmail.com</p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <div style={{ color: 'var(--primary)', fontSize: '1.5rem' }}>📞</div>
            <p className="text-muted" style={{ margin: 0, fontSize: '1.15rem' }}>+91 9971145505</p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <div style={{ color: 'var(--primary)', fontSize: '1.5rem' }}>📍</div>
            <p className="text-muted" style={{ margin: 0, fontSize: '1.15rem' }}>3-14, Rayanapadu Gate, Vijayawada, Andhra Pradesh</p>
          </div>
        </div>
      </div>
    </div>
